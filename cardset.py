...
class cardset():
    ...
    cardtype=[
		...
		[ 0,12], #2 13 card of 0:RH mode hearts 紅心
		[13,25], #3 13 card of 1:RD mode diamonds 方塊
		[26,38], #4 13 card of 2:BF mode clubs 梅花
		[39,51], #5 13 card of 3:BH mode spades 黑桃
